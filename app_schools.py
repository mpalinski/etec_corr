...
app.layout = html.Div([
    ...
    html.Div([html.P(dash_dangerously_set_inner_html.DangerouslySetInnerHTML(''))],id='stats', style={'display': 'block','align':'center' ,'marginLeft': 'auto', 'marginRight': 'auto'})
...
def stats(xaxis_column_name, yaxis_column_name, country_column_name,
                 xaxis_type, yaxis_type
                 ):
    dff=df_schools[df_schools['Country Name']==country_column_name]
    ...
    fig.update_traces(customdata=dff[df_schoolsf['Indicator Name'] == yaxis_column_name]['Country Name'])
